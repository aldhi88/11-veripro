...
return new class extends Migration
{
    ...
    {
        Schema::create('khs_amandemen_designators', function (Blueprint $table) {
            $table->id();

            $table->foreignId('khs_amandemen_id')->constrained();
    ...
    {
        Schema::dropIfExists('khs_amandemen_designators');
    }
};
