...
class InvoiceRevisiTagihan extends Component
{
    ...
    public function submit()
    {
        ...
        TagihanHistory::create([
            'tagihan_id' => $this->editId,
            'status' => 10,
            'json' => $dt['json']
        ]);

        session()->flash('message', 'Perbaikan Revisi Data Tagihan Tahap 2 sudah berhasil di kirim kembali.');
    ...
    public function setGudangFirst(){
        $this->dt['dt_tagihan'] = json_decode($this->dtEdit['json'],true)['dt_tagihan'];
