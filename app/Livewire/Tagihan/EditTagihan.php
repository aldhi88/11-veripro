...
class EditTagihan extends Component
{
    ...
    {
        return view('mods.tagihan.edit_tagihan');
    }
    ...
    {
        $this->dtEdit = Tagihan::whereId($id)->first()->toArray();
        $this->dtEdit['json'] = json_decode($this->dtEdit['json'], true);
        unset(
            $this->dtEdit['created_at'],
            $this->dtEdit['updated_at'],
            $this->dtEdit['deleted_at'],
            $this->dtEdit['status_label'],
            $this->dtEdit['status_desc'],
        );
        $this->dt['dt_sp'] = $this->dtEdit['json']['dt_sp'];
        $this->dt['dt_tagihan'] = $this->dtEdit['json']['dt_tagihan'];
        $this->allDesigs = $this->dt['dt_tagihan']['dt_gudang']['all_desig'];
    ...
    public function submit()
    {
        ...
        SpInduk::find($this->dtEdit['sp_induk_id'])->update(['status' => 2]);
