                    ...
                    <form wire:submit="submit">
                        ...
                        <div class="row">
                            ...
                            <div class="col col-md-3">
                                <div class="form-group">
                                    <label>Tanggal</label>
                                    <input min="{{$dtEdit['tgl_berlaku']}}" type="date" wire:model="dtEdit.tgl_berlaku" class="form-control @error('dtEdit.tgl_berlaku') is-invalid @enderror">
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="file" wire:model="desigFile" class="form-control @error('desigFile') is-invalid @enderror">
                                    @error('desigFile')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col text-right">
                                <button type="submit" class="btn btn-primary">Buat Amandemen {{$amanKe}}</button>
                            </div>
                        </div>
