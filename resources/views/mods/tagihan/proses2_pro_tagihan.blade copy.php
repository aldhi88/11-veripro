            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs nav-tabs-custom nav-justified" role="tablist">
                        <li class="nav-item" wire:click="changeTab(8)"  style="cursor: pointer">
                            <a class="nav-link {{ $tab==8?'active':null }}">
                    ...
                    <div class="tab-content text-muted pt-4">
                        {{-- last --}}
                        <div class="tab-pane {{ $tab==8?'active':null }}" id="tab8" role="tabpanel">
                            <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" wire:model="dt.dt_tagihan.no_bayar" readonly class="bg-light form-control @error('dt.dt_tagihan.no_bayar') is-invalid @enderror">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" wire:model="dt.dt_tagihan.tgl_bayar" readonly class="bg-light form-control @error('dt.dt_tagihan.tgl_bayar') is-invalid @enderror">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" wire:model="dt.dt_tagihan.no_invoice" readonly class="bg-light form-control @error('dt.dt_tagihan.no_invoice') is-invalid @enderror">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" wire:model="dt.dt_tagihan.tgl_invoice" readonly class="bg-light form-control @error('dt.dt_tagihan.tgl_invoice') is-invalid @enderror">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" wire:model="dt.dt_tagihan.no_kwitansi" readonly class="bg-light form-control @error('dt.dt_tagihan.no_kwitansi') is-invalid @enderror">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" wire:model="dt.dt_tagihan.tgl_kwitansi" readonly class="bg-light form-control @error('dt.dt_tagihan.tgl_kwitansi') is-invalid @enderror">
