<div>
    ...
    <div class="row">
        ...
        <div class="col text-right">
            <a href="{{ route('tagihan.index') }}" class="btn btn-success btn-sm">Semua Tagihan</a>
        </div>
    </div><hr>
                ...
                <div class="card-body">
                    ...
                    <form wire:submit="submit">
                        ...
                        <ul class="nav nav-tabs nav-tabs-custom nav-justified" role="tablist">
                            ...
                            @if (isset($dt['dt_tagihan']['no_nodin']))
                        ...
                        <div class="tab-content text-muted pt-4">
                            ...
                            <div class="tab-pane {{ $tab==4?'active':null }}" id="tab4" role="tabpanel">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="py-0 px-1 alert alert-warning alert-dismissible fade show" role="alert">
                                            <div class="row">
                                                <div class="col" style="display: flex; align-items: center;">
                                                    <h1 class="m-0 mr-2"><i class="ri-information-line"></i></h1>
                                    ...
                                    <div class="col">
                                        <div class="py-0 px-1 alert alert-warning alert-dismissible fade show" role="alert">
                                            <div class="row">
                                                <div class="col" style="display: flex; align-items: center;">
                                                    <h1 class="m-0 mr-2"><i class="ri-information-line"></i></h1>
                                                    <p class="m-0">Sebelum mulai input data <strong>Gudang</strong>, pastikan data pada form <strong>Designator</strong> 
                                                        sudah tidak ada perubahan lagi, perubahan pada bagian <strong>Designator</strong> akan mereset
                                                        data <strong>Gudang</strong> yang telah diinput sebelumnya.</p>
                                                </div>
                                            </div>
                                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                                <span aria-hidden="true">×</span>
