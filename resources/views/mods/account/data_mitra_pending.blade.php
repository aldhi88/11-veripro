<div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="dt-responsive table-responsive mt-2">
                        <table id="myTable" class="small table table-bordered table-striped dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            <thead>
                            <tr>
    ...
    @include('mods.account.atc.data_mitra_pending_atc')
