<div>
                ...
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs nav-tabs-custom nav-justified" role="tablist">
                        <li class="nav-item" wire:click="changeTab('data')"  style="cursor: pointer">
                            <a class="nav-link {{ $tab=='data'?'active':null }}">
                                ...
                                <span class="d-none d-sm-block">Data SP Amandemen-{{$amanKe}}</span> 
                            </a>
                        </li>
                    ...
                    <div class="tab-content text-muted pt-4 px-3">
                        ...
                        <div class="tab-pane active" id="tab1" role="tabpanel">
                            <div class="{{$dData}}">
                                @include('mods.sp.aman_create_sp_tab_data')
                            </div>
                            
                            <div class="{{$dDesig}}">
                                @include('mods.sp.aman_create_sp_tab_desig')
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col text-right">
                            <button type="button" wire:click="submit" class="btn btn-primary">Terbitkan SP</button>
                        </div>
                    </div>
    ...
    @include('mods.sp.atc.aman_create_sp_atc')
